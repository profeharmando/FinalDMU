 ...
 * @author hector
 */
public class ReprobadosEspañolMatematicas {
    ...
    public ReprobadosEspañolMatematicas(int codigo, String grado, 
    ...
    public ReprobadosEspañolMatematicas(int codigo) { 
        this.codigo = new SimpleIntegerProperty(codigo);
    }
    ...
    //Metodos atributo: codigo_centro
    public int getCodigoCentro() {
        return codigo_centro.get();
    }
    public void setCodigoCentro(int codigo_centro) {
        this.codigo_centro = new SimpleIntegerProperty(codigo_centro);
    }
    public IntegerProperty CodigoSaceProperty() {
